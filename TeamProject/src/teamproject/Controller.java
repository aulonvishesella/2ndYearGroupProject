    ...
    class LoginAuth implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String role = jdbc.retrieveRole(login.getUsername());
                    ...
                    try {
                        ...
                        if( jdbc.validate_login(login.getUsername(), login.getPassword())==true){
                            ...
                            if("Receptionist".equals(jdbc.retrieveRole(login.getUsername())) || "receptionist".equals(jdbc.retrieveRole(login.getUsername()))){
                                login.dispose();
                                
                                bapers.setVisible(true);
                                bapers.setPanelRecep(e.getActionCommand());
                                bapers.setUser(jdbc.retrieveRole(login.getUsername()));
                            }
